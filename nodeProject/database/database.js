...
function connect(app, config) {
	...
	mariadb.Promise = global.Promise;  // mongoose의 Promise 객체는 global의 Promise 객체 사용하도록 함
	mariadbe.connect(config.db_url);
	mariadb.db = mariadb.connection;
	
	database.db.on('error', console.error.bind(console, 'mariadb connection error.'));	
