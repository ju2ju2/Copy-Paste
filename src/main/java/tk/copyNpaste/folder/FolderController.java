...
public class FolderController {
	...
	public @ResponseBody void selectAllFolder(Model model,Principal principal) throws Exception {
	...
	public void updateFolder(FolderVO folder, Principal principal) throws Exception {
