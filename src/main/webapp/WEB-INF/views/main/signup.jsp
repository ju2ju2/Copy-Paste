		...
		<div class="center-block ">
			...
			<hr>
				...
				<a class="btn btn-md social-btn" id="kakaoSignup" 
					href="https://kauth.kakao.com/oauth/authorize?client_id=495904a0b4023192de3119bfde795283&redirect_uri=http://192.168.0.134:8090/copyNpaste/member/kakaoOauth.do&response_type=code"> 
