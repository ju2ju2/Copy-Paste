			...
			<div>
				...
				<form id="signin" class="form-signin" name="f1" action="${loginUrl}"
					...
					<div class="text-center">
						<hr>
						<!-- 카카오 -->
						<a id="custom-login-btn" href="https://kauth.kakao.com/oauth/authorize?client_id=495904a0b4023192de3119bfde795283&redirect_uri=http://13.124.12.183/copyNpaste/member/kakaoOauth.do&response_type=code">
